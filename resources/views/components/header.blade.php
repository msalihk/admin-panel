<header class="fixed top-0 left-0 right-0 z-50 border-black border-solid border-2">
    <nav class="bg-white">
       <div class="xl:container mx-auto px-3 sm:px-4 xl:px-2">
         <div class="flex justify-between">
           <div class="mx-w-10 text-2xl font-bold capitalize text-black flex items-center">haber sitesi</div>
