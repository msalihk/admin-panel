...
@section('content')
<div class="">
    <div class="bg-bbcRed w-full py-3 mb-20">
        <div class="container mx-auto max-w-7xl">
            <span class="uppercase mx-4 xl:mx-0 text-black text-4xl font-bold py-2">TV</span>
        </div>
    </div>
    <div class="container max-w-7xl mx-auto">
        ...
        <div class="flex justify-center items-center h-40 my-40 flex-col">
            <p class="text-gray-600 text-lg">There are no post in "Tv" Category</p>
